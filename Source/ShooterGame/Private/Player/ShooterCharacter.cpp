	...
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UShooterCharacterMovement>(ACharacter::CharacterMovementComponentName))
{
	...
	// DvTODO:: Mesh1P->bReceivesDecals = false;
	...
	// DvTODO:: GetMesh()->bReceivesDecals = false;
...
void AShooterCharacter::PreReplication(IRepChangedPropertyTracker & ChangedPropertyTracker, bool bIsSavingCheckpoint)
{
	Super::PreReplication(ChangedPropertyTracker, bIsSavingCheckpoint);
