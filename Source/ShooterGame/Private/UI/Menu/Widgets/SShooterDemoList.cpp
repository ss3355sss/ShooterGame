...
void SShooterDemoList::BuildDemoList()
{
	...
	{
		ReplayStreamer->EnumerateStreams(EnumerateStreamsVersion, FString(), FString(), 0, 0, FOnEnumerateStreamsComplete::CreateSP(this, &SShooterDemoList::OnEnumerateStreamsComplete));
